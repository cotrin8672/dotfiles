return {
  ...
  opts = function()
    ...
    local function section_builtin_actions_with_icon()
      local icons = require("mini.icons")
      local actions = {
        { name = "Lazy", action = "Lazy", section = SECTION_KEYMAPS },
        { name = "Oil", action = "Oil --float", section = SECTION_KEYMAPS },
        { name = "Edit new buffer", action = "enew", section = SECTION_KEYMAPS },
        { name = "Quit Neovim", action = "qall", section = SECTION_KEYMAPS },
      }
