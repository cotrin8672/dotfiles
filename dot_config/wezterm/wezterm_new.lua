...
local ICONS                          = {
    wsl = wezterm.nerdfonts.cod_terminal_ubuntu, -- WSL逕ｨ・・inux繧｢繧､繧ｳ繝ｳ・・
    cmd = wezterm.nerdfonts.oct_terminal,        -- Windows逕ｨ・・indows繧｢繧､繧ｳ繝ｳ・・
    fallback = wezterm.nerdfonts.fa_terminal,    -- 縺昴ｌ莉･螟悶・豎守畑繧｢繧､繧ｳ繝ｳ
}
local ICON_COLORS                    = {
    wsl = "#DF4E1C",      -- WSL繧｢繧､繧ｳ繝ｳ縺ｮ濶ｲ
    cmd = "#CCCCCC",      -- Windows繧｢繧､繧ｳ繝ｳ縺ｮ濶ｲ
    fallback = "#FFFFFF", -- 縺昴・莉悶・繧｢繧､繧ｳ繝ｳ縺ｮ濶ｲ
}
